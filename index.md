...
The 2nd EReL@MIR workshop will be held with ACM Multimedia 2026 in Rio de Janeiro, Brazil. Building on the first edition, this workshop focuses on efficient and deployable multimodal representation learning for information retrieval in the era of foundation models.

This year especially highlights efficient omni-modal MIR and efficient multimodal generative MIR, alongside core directions such as efficient adaptation, fusion, interaction, inference, and benchmarking.
